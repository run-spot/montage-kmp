...
fun WantedSlider(
    ...
    WantedRangeSliderContainer(
        ...
        onValueChange = { range -> onValueChange(range.endInclusive) }
    )
}
...
@Composable
private fun WantedRangeSliderContainer(
    value: ClosedFloatingPointRange<Float>,
    valueRange: ClosedFloatingPointRange<Float>,
    onValueChange: (ClosedFloatingPointRange<Float>) -> Unit,
    modifier: Modifier = Modifier,
        ...
        slider = { sliderWidth ->
            WantedRangeSlider(
                ...
                onValueChange = { range ->
                    ...
                    maxOffsetX.floatValue =
                        getTextOffset(range.endInclusive, sliderWidth, maxTextWidth.floatValue)
                    onValueChange(range)
                },
                ...
                Text(
                    modifier = Modifier
                        ...
                        .onGloballyPositioned { layoutCoordinates ->
                            ...
                            minOffsetX.floatValue =
                                getTextOffset(value.start, sliderWidth, minTextWidth.floatValue)
                        },
                    text = labelMin
                )
            }
...
private fun getTextOffset(
    ...
    var offset =
        ((stepSize * step) + (stepSize * remain) + margin - (textWidth * 0.5f) - ThumbRadius.value).toFloat()
    if (offset < 0f) {
        offset = 0f
    }
