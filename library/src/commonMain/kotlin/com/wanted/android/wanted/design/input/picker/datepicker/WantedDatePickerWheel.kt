...
fun WantedDatePickerWheel(
    ...
    var selectMonth by remember(selectedMonth) { mutableIntStateOf(selectedMonth) }
    var enabledYear by remember {
        mutableStateOf(default.enableMinYear <= selectYear && selectYear <= default.enableMaxYear)
    }
    var enabledMonth by remember {
        mutableStateOf(default.enableMinMonth <= selectMonth && selectMonth <= default.enableMaxMonth)
    }
