...
val DarkWantedColorScheme = WantedColorScheme(
    ...
    primaryNormal = color(0xFF3385FF),
    primaryStrong = color(0xFF1A75FF),
    primaryHeavy = color(0xFF0066FF),

    labelNormal = color(0xFF171719),
    labelStrong = color(0xFFFFFFFF),
    labelNeutral = color(0xE0C2C4C8),
    labelAlternative = color(0xFF37383C),
    labelAssistive = color(0x47AEB0B6),
    labelDisable = color(0x29989BA2),

    backgroundNormalNormal = color(0xFF1B1C1E),
    backgroundNormalAlternative = color(0xFF0F0F10),
    backgroundElevatedNormal = color(0xFF212225),
    backgroundElevatedAlternative = color(0xFF141415),
    backgroundTransparentNormal = color(0xFFFFFFFF),
    backgroundTransparentAlternative = color(0xFFFFFFFF),

    interactionInactive = color(0xFF5A5C63),
    interactionDisable = color(0xFF2E2F33),

    lineNormalNormal = color(0x5270737C),
    lineNormalNeutral = color(0x4770737C),
    lineNormalAlternative = color(0x3870737C),
    ...
    statusNegative = color(0xFFFF6363),
